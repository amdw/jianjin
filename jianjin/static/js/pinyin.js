...
pinyin.constant('convert', function(text) {
  ...
  var pickVowel = function(syllable) {
    var firstVowelIdx = -1;
  ...
  var convertPart = function(part) {
    ...
    return part.substr(0, part.length - syllable.length - 1) + syllable.substr(0, vowelIdx) + newVowel + syllable.substr(vowelIdx + 1);
  };
